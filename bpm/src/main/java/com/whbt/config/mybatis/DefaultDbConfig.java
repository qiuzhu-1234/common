package com.whbt.config.mybatis;

import com.whbt.config.mybatis.wrapper.MapWrapperFactory;
...
@Configuration  
@MapperScan(basePackages = {"com.whbt.**.mapper"},annotationClass = UsingDefaultDB.class, sqlSessionFactoryRef = "defaultSqlSessionFactory")
public class DefaultDbConfig {
	
	private String aliasesPackage = "com.whbt.**.model";
